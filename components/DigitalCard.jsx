    ...
    <div className="space-y-6">
      ...
      <div className="bg-white/80 dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="p-2 sm:p-4 space-y-4 sm:space-y-6">
          {/* 名刺プレビュー - シェアページと完全一致させる */}
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-0 sm:p-2">
            <div className="flex justify-center w-full">
              <div 
                ref={cardRef}                      className="relative rounded-xl shadow-lg overflow-hidden transform hover:scale-[1.02] transition-transform duration-300 cursor-pointer"
                      style={{
                        width: '100%',
                        maxWidth: '540px',
                        aspectRatio: '1.618/1',
